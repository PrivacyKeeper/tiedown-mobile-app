...
// analyze-team-video edge function for tiedown.
//
...
const SYSTEM_PROMPT =
  "You are an expert tiedown coach reviewing a roster athlete's run for a coaching team. " +
        ...
        messages: [
          { role: "system", content: SYSTEM_PROMPT + " JSON schema: " + JSON.stringify(ANALYSIS_SCHEMA) },
          {
            ...
            content: [
              {
                type: "text",
                text: `Analyze this tiedown run${athlete_name ? ` by ${athlete_name}` : ""}.`,
              },
              ...images,
            ],
          },
